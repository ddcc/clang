...
public:
  ...
  /// canReasonAboutFloats - Not all ConstraintManagers can reason about
  ///  floating-point values. Instead of first instantiating a floating-point
  ///  SVal to query whether it is supported, use this to ask directly.
